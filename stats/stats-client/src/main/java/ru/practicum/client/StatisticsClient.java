...
public class StatisticsClient {
    ...
    public ResponseEntity<List<StatsDto>> getStatistics(String start, String end, List<String> uris,
                                                        Boolean unique) {
    ...
    private ResponseEntity<List<StatsDto>> invokeHttp(HttpMethod httpMethod, String path,
                                                      HttpEntity<String> requestEntity) {
        ResponseEntity<List<StatsDto>> statServerResponse = null;
        ParameterizedTypeReference<List<StatsDto>> responseType = new ParameterizedTypeReference<>() {
        };
